...
landscape = {w: screenW, h: 30, clr: "green", x: 3, y: getY(30, screenH), n: "land"}
 ...
 // console.log(lvl)
  ...
  switch (level) {
    ...
    gameobjects = { 
      landscape : new gameobject(landscape),
      protagonist : new Protagonist(protagonistArg),
      smallTree: new gameobject(new tree({h: 20, x: 50, w: 50, n:"st1"})), 
      smallTree2: new gameobject(new tree({h: 30, x: 100, w: 50, n: "st2"})),
      smallTree3: new gameobject(new tree({h: 100, x: 150, w: 200, n: "st3"})), 
    }
    break;
...
ctx.fillRect(10, 10, 100, 100);
  ...
  function updateGameArea() {
   ...
   // updateTextBox();
    ...
    for (let x in gameobjects ) { 
      gameobjects[x].redraw();
       //console.log(ind)

    }
    
    gameobjects.protagonist.animate();
